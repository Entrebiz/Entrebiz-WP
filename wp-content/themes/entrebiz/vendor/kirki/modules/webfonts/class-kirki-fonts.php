...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'rodller' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'rodller' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'rodller' ),
			'200'       => esc_attr__( 'Light 200', 'rodller' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'rodller' ),
			'300'       => esc_attr__( 'Book 300', 'rodller' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'rodller' ),
			'400'       => esc_attr__( 'Normal 400', 'rodller' ),
			'regular'   => esc_attr__( 'Normal 400', 'rodller' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'rodller' ),
			'500'       => esc_attr__( 'Medium 500', 'rodller' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'rodller' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'rodller' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'rodller' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'rodller' ),
			'700'       => esc_attr__( 'Bold 700', 'rodller' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'rodller' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'rodller' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'rodller' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'rodller' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'rodller' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'rodller' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'rodller' ),
		);
	}
