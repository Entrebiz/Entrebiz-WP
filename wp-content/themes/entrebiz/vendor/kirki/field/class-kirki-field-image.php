...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'rodller' ),
				'change'       => esc_attr__( 'Change image', 'rodller' ),
				'default'      => esc_attr__( 'Default', 'rodller' ),
				'remove'       => esc_attr__( 'Remove', 'rodller' ),
				'placeholder'  => esc_attr__( 'No image selected', 'rodller' ),
				'frame_title'  => esc_attr__( 'Select image', 'rodller' ),
				'frame_button' => esc_attr__( 'Choose image', 'rodller' ),
			)
		);
	}
