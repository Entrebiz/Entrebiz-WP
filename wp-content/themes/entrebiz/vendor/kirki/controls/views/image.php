...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_attr_e( 'Select image', 'rodller' ); ?>',
	change: '<?php esc_attr_e( 'Change image', 'rodller' ); ?>',
	'default': '<?php esc_attr_e( 'Default', 'rodller' ); ?>',
	remove: '<?php esc_attr_e( 'Remove', 'rodller' ); ?>',
	placeholder: '<?php esc_attr_e( 'No image selected', 'rodller' ); ?>',
	frame_title: '<?php esc_attr_e( 'Select image', 'rodller' ); ?>',
	frame_button: '<?php esc_attr_e( 'Choose image', 'rodller' ); ?>',
} );
#>
