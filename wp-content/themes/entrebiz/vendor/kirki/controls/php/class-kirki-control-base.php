	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'rodller' ),
				'remove'               => esc_attr__( 'Remove', 'rodller' ),
				'default'              => esc_attr__( 'Default', 'rodller' ),
				'selectFile'           => esc_attr__( 'Select File', 'rodller' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'rodller' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'rodller' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'rodller' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'rodller' ),
			)
		);
